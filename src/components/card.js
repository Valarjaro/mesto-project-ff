import { putLike, deleteLike } from '../components/api.js'
...
export function addCard (cardDataSource, cardRemoveCallback, showPopupImage, likeCard, cardId, likeCount, likedByMe) {
    // клонировать шаблон,
